...
$module_id = "12";
$parent_id = '21';
$menu_id = "complaint_product_list";
              ...
              <tbody>
                <?php foreach ($data as $row){ ?>
                    <tr>
                        ...
                        <td class="center">
                            <a class="btn btn-primary btn-sm checkUpdate" href="complaint_product_add.php?id=<?php echo $row['id']; ?>">
          ...
          if (isConfirm) 
          {
              $.ajax({
                  ...
                  success: function(data) 
                  {
                    ...
                    {
                      swal({ title: "Error! Cant'deleted", text:  "Complaint Or Lead May be locked against the product .", type: "error" , confirmButtonClass: "btn-danger" ,timer: 2000 });
                    }      
                  }
              });
          } 
