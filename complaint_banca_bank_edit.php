<?php
    ...
    $data                   = $objComplaint->GetComplaintByIdBancaBank($id,$cmode); 
?>
...
<div class="row">
    <form class="form-horizontal" action="#" method="POST" id="complaintBB">
        ...
        <input type="hidden" id="actionBB" name="actionBB" value="edit_complaint">
        ...
        <input type="hidden" name="txtCounterDisplayBB" id="txtCounterDisplayBB" value="<?php echo $data[0]['complaint_num'];?>" />
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtGroupNoBBB" name="txtGroupNoBBB" class="form-control" placeholder="Group No" value="<?php echo $data[0]['group_no']; ?>" >
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtCertificateBBB" name="txtCertificateBBB" class="form-control"  placeholder="Certificate No" maxlength="12"  value="<?php echo $data[0]['certificate_no']; ?>">
            ...
            <div class="col-md-12">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control my-datepicker" name="policy_issuance_dateBB" id="policy_issuance_dateBB" placeholder="Pick Preferable Date and Time" tabindex="13" value="<?php echo Date('d/m/Y',strtotime($data[0]['policy_issuance_date'])) ?>"/>
            ...
            <div class="col-md-12">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtPremiumAmountBB" name="txtPremiumAmountBB" class="form-control" placeholder="Enter Premium Amount" onkeypress="return validateNumbers(event)" value="<?php echo $data[0]['premium_amount']; ?>">
                ...
                <!-- <div class="col-md-3" style="display: none;">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtRefundAmountBB" name="txtRefundAmountBB" class="form-control" placeholder="Enter Refund Amount" onkeypress="return validateNumbers(event)"  value="<?php echo $data[0]['refund_amount']; ?>">
                    </div>
                </div>
                <div class="col-md-1">
                </div> -->
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtAmountClaimedBB" name="txtAmountClaimedBB" class="form-control" placeholder="Enter Amount" onkeypress="return validateNumbers(event)" value="<?php echo $data[0]['claim_amount']; ?>">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control my-datepicker" id="reported_dtBB" value="<?php echo Date("d/m/Y",strtotime($data[0]['reported_dt'])) ?>" placeholder="Complaint Received Date">
                        <span style="float: right; margin: -25px 15px 0px 0px;" class="input-group-input"><i class="fa fa-calendar"></i></span>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control my-datepicker" id="received_dateB" value="<?php echo Date("d/m/Y",strtotime($data[0]['received_date'])) ?>" placeholder="Complaint Received Date">
                        <span style="float: right; margin: -25px 15px 0px 0px;" class="input-group-input"><i class="fa fa-calendar"></i></span>
                        <div class="input-error form-control-input" style="color: Red; display: none;">Complaint Received Date is required</div>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtCompanyNameBB" name="txtCompanyNameBB" class="form-control" placeholder="Company Name" onkeypress="return validateAlphabets(event)" value="<?php echo $data[0]['company_name']; ?>">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtMemberNameBB" name="txtMemberNameBB" class="form-control" placeholder="Member Name" onkeypress="return validateAlphabets(event)" value="<?php echo $data[0]['customer_name']; ?>">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtAgentBrokerBB" name="txtAgentBrokerBB" class="form-control" value="<?php echo $data[0]['agency']; ?>" placeholder="Agent or Broker Name" disabled="true">
                    </div>
                </div>
                <div class="col-md-1">
                </div>
            ...
            <div class="col-md-12">
                <div class="col-md-7">
                    <div class="form-group">
                        ...
                        <textarea placeholder="Additional Information" id="txtDescriptionBB" name="txtDescriptionBB" rows="6" class="form-control"><?php echo $data[0]['description']; ?></textarea>
                    </div>
                </div>
                <div class="col-md-1">
                </div>
            ...
            <div class="col-md-12">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtCallBackBB" name="txtCallBackBB" class="form-control" onkeypress="return validateNumbers(event)" placeholder="021XXXXXXXX" maxlength="11" value="<?php echo $data[0]['residence_phone']; ?>">
                    </div>
                </div>
                <div class="col-md-1">
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtHomePhoneBB" name="txtHomePhoneBB" class="form-control" onkeypress="return validateNumbers(event)" placeholder="92XXXXXXXXXX" maxlength="12" value="<?php echo $data[0]['callback_num']; ?>">
                    </div>
                </div>
                <div class="col-md-1">
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtMobileBB" name="txtMobileBB" class="form-control" onkeypress="return validateNumbers(event)" placeholder="92XXXXXXXXXX" maxlength="12" value="<?php echo $data[0]['mobile_number']; ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtOfficePhoneBB" name="txtOfficePhoneBB" class="form-control" onkeypress="return validateNumbers(event)" placeholder="021XXXXXXXX" maxlength="12" value="<?php echo $data[0]['office_phone']; ?>">
                    </div>
                </div>
                <div class="col-md-1">
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <!-- <div class="input-group"> -->
                            <input type="text" class="form-control" id="txtEmailBB" name="txtEmailBB" placeholder="example@mail.com" value="<?php echo $data[0]['email']; ?>">
            ...
            <div class="col-md-12">
                <div class="col-md-11">
                    <div class="form-group">
                        ...
                        <textarea rows="6" placeholder="Enter Office Address" id="txtOfficeAddressBB" name="txtOfficeAddressCOfficeAddressBB" class="form-control"><?php echo $data[0]['office_address']; ?></textarea>
                    </div>
                </div>
                <div class="col-md-1">
                </div>
            ...
            <div class="col-md-12">
                <div class="col-md-11">
                    <div class="form-group">
                        ...
                        <textarea rows="6" placeholder="Enter Address" id="txtCorrespondenceAddressBB" name="txtCorrespondenceAddressBB" class="form-control"><?php echo $data[0]['delivery_address']; ?></textarea>
            ...
            <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <div class="radio radio-css radio-inline radio-success">
                                <input type="radio" name="rdSMSBB" id="radio_inline_css_bb3" value="1"<?php echo $data[0]['is_sms'] == '1' ? 'checked': '' ?>>
                                <label for="radio_inline_css_bb3">
                                    Yes
                                </label>
                            </div>
                            <div class="radio radio-css radio-inline radio-danger">
                                <input type="radio" name="rdSMSBB" id="radio_inline_css_bb4" value="0" <?php echo $data[0]['is_sms'] == '0' ? 'checked': '' ?>>
                ...
                <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="12" class="form-control" id="txtcusNumberBB" name="txtcusNumberBB" onkeypress="return validateNumbers(event)" placeholder="92XXXXXXXXXX" value="<?php echo $data[0]['response_number']; ?>">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div>
                                <div class="radio radio-css radio-inline radio-success">
                                    <input type="radio" name="rdCallBackBB" id="radio_inline_css_bb12" value="1" <?php echo $data[0]['is_call_back'] == '1' ? 'checked': '' ?>>
                                ...
                                <div class="radio radio-css radio-inline radio-danger">
                                    <input type="radio" name="rdCallBackBB" id="radio_inline_css_bb21" value="0" <?php echo $data[0]['is_call_back'] == '0' ? 'checked': '' ?>>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#ddlReportedByBB').trigger('change');
    });
    ...
    function getcmp_type_co_banca()
    {
        ...
        $.ajax({
            ...
            $('#ddlComplaintTypeBBB').val('<?php echo $data[0]['complaint_type_id']; ?>').trigger('change');
        });
    }
    get_cmp_type_detail_co_banca();
    ...
    function validation_co_banca()
    {
        ...
        if(ddlReportedBy != "hospitals")
        {
            ...
            //     //$('#txtRefundAmountBB').parents('.control-group').addClass('success');
