...
$page_title = "Complaint Product";
$permission_type = "create";
$module_id = "35";
$parent_id = '21';
$menu_id = "complaint_product_add";
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="" method="POST">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="txtProductId" value="<?php echo($data[0]['id']); ?>" placeholder="Product Id" disabled />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="txtProductName" id="txtProductName" value="<?php echo($data[0]['fullname']); ?>" placeholder="Product Name" onkeypress="return validateAlphabets(event)"/>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#btnCategorySave', function () {
            ...
            var id = $('#txtProductId').val() !=0 ? $('#txtProductId').val() : 0;
            var action = id == 0 ? "product_save" : "product_edit";
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if(data == 'success'){
                            ...
                            setTimeout(function () { window.location.href = "complaint_product_list.php" }, 3000);
                        }else if(data == 'fail'){
