                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" autocomplete="off" data-parsley-validate="true">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="txtUserId" id="txtUserId" value="<?php echo($data[0]['user_name']); ?>" placeholder="User Id" data-parsley-required="true"/>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="txtEmail" id="txtEmail" <?php echo $isdisabled; ?> value="<?php echo($data[0]['email']); ?>" placeholder="example@mail.com" data-parsley-required="true"/>
                            ...
                            <fieldset>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" name="txtPassword" id="txtPassword" value="" <?php echo $isdisabled; ?>>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" name="txtConfirmPassword" id="txtConfirmPassword" value="" <?php echo $isdisabled; ?> />
                                        ...
                                        <a href="" id="HypChangePass" style="<? echo $is_display ?>" >Change Password</a>
                                    </div>
                                </div>
                                <div class="col-md-1">
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="datepicker-autoClose1" value="<?php echo $data[0]['expiry_datetime'] != "" ?  ($objUser->DateTimeToString($data[0]['expiry_datetime'])) : date("m/d/Y", strtotime("+365 days")); ?>"/>
                        ...
                        <fieldset id="group_role" <? echo $group_assign; ?>>
                            <div class="col-md-12">
                                <ul class="nav nav-tabs nav-tabs_1 nav-tabs-new">
                                    <li class="active">
                                                        ...
                                                        <ul>
                                                            <li data-jstree='{"opened":true}' >
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>General</li>
                                                                    <li>Manager</li>
                                                                    <!--<li data-jstree='{ "icon" : "fa fa-warning fa-lg text-danger" }'>custom icon class (fontawesome)</li><li data-jstree='{ "icon" : "fa fa-link fa-lg text-primary" }'><a href="http://www.jstree.com">Clickable link node</a></li>-->
                                                                </ul>
                                                            </li>
                                                            <!--<li>Root node 2</li>-->
                                                        </ul>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '#HypChangePass', function () {
                ...
                $.ajax({
                    ...
                    success: function(data) 
                    {
                        ...
                        else if(data == 'email already exists')
                        {
                            ...
                            $('#txtEmail').focus();
                            $.notifyBar({ cssClass: "error", html: "Email Address Already Exists", delay: 2000, animationSpeed: "normal" });
                        }
                        else if(data == 'fail')
                        {
                            $('html, body').animate({scrollTop: 0}, 600);
    ...
    function validation(group_id)
    {
        ...
        if($('#ddlUserType').val() == null) 
        {
            ...
            $('#ddlUserType').parent().find('.select2-container--default').show().addClass('error-val');
        ...
        else
        {
            ...
            $('#ddlUserType').parent().find('.select2-container--default').show().removeClass('error-val');
            //$('#ddlUserType').parents('.control-group').addClass('success');
        ...
        if($('#ddlUserType').val() != '3')
        {
            if(group_id == '') 
            {
                if($('#ddlGroupAssign').val() == null) 
                {
                    $('#ddlGroupAssign').addClass('error-val');
                    $('#ddlGroupAssign').parent().find('.input-error').show().css('display', 'inline-block');
                    $('#ddlGroupAssign').parent().find('.select2-container--default').show().addClass('error-val');

                    if (!hasFocus) 
                    {
                        $('#ddlGroupAssign').focus();
                        hasFocus = true;
                    }
                    errCount++;
                }
                ...
                {
                    $('#ddlGroupAssign').removeClass('error-val');
                    $('#ddlGroupAssign').parent().find('.select2-container--default').show().removeClass('error-val');
                    //$('#ddlGroupAssign').parents('.control-group').addClass('success');
                    $('#ddlGroupAssign').parent().find('.input-error').hide();
                }
            }
            else 
            {
