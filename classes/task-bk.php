...
class Task 
{
    ...
    function SaveTaskNew($counter, $task_num, $task_cat, $task_subcat, $task_ism, $task_ism_desc, $task_title, $task_desc, $login_id, $group_id, $assigned_to, $verified_by, $cc_users, $start_time, $end_time, $priority, $task_ism_id, $policy_number, $tid)
    {
    ...
    function GetTask($login_id,$user_type,$group_id)
    {
        $query = '';
    ...
    function ProgressTask($login_id,$task_id,$progress,$comments,$policy,$priority,$ism,$start_time) 
    {
        ...
        $task_bf = $this->mysqli_lib->fetch_all($query); 
