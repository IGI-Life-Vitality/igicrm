...
class TaskcatReport
{
    ...
    function getTaskRating($ism_id,$duration,$month,$quarter,$year,$department_id)
    {
        ...
        $query = "SELECT 
                    (SELECT COUNT(*) FROM tbl_task_new WHERE task_ism = '$ism_id' AND task_status_id = '3' AND group_id = '$department_id' AND task_update_date <= task_end_datetime $data) AS task_within_tat,
                    (SELECT COUNT(*) FROM tbl_task_new WHERE task_ism = '$ism_id' AND task_status_id = '3' AND group_id = '$department_id' $data) AS total_service_request,
                    (SELECT COUNT(*) FROM tbl_task_new WHERE task_ism = '$ism_id' AND task_status_id = '3' AND group_id = '$department_id' $data) AS total_closed_service";
        //return $query;
        return $this->mysqli_lib->fetch_all($query);
    }
    ...
    function getTodayTask($ism_sub_cat_id,$ism_id,$present_date,$task_status)
    {
        ...
        $query .= "SELECT COUNT(*) AS task_counts FROM tbl_task_new WHERE task_subcat = '$ism_sub_cat_id' AND task_ism = '$ism_id' AND DATE(task_create_date) = '$present_date' AND parent_task_id = '0' ORDER BY task_id ASC";
        //return $query;
        return $this->mysqli_lib->fetch_all($query);
    }
    ...
    {
        $query  = "";
        $query .= "SELECT COUNT(*) AS task_counts FROM tbl_task_new WHERE task_subcat = '$ism_sub_cat_id' AND task_ism = '$ism_id' AND DATE(task_update_date) = '$present_date' AND task_status_id IN ($task_status) AND parent_task_id = '0' ORDER BY task_id ASC";
        //return $query;
        return $this->mysqli_lib->fetch_all($query);
    }
