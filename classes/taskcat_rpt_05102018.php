...
class TaskcatReport
{
    ...
    function getTaskRating($ism_id,$duration,$month,$quarter,$year)
    {
        ...
        $query = "SELECT 
                    ...
                    (SELECT COUNT(*) FROM tbl_task_new WHERE task_ism = '$ism_id' AND task_status_id = '3' $data) AS total_service_request,
                    (SELECT COUNT(*) FROM tbl_task_new WHERE task_ism = '$ism_id' AND task_status_id = '3' $data) AS total_closed_service";
        //return $query;
        return $this->mysqli_lib->fetch_all($query);
    }

    function getScoreCurrentMonth($group_id)
    {
        $query = "SELECT COUNT(*) AS total_ism_where_task_closed FROM tbl_task_new WHERE group_id = '$group_id' AND parent_task_id = '0' AND task_status_id = '3' GROUP BY task_ism";
        //return $query;
        return $this->mysqli_lib->fetch_all($query);
    }
    ...
    function getCFDetails($ism_type,$ism_code,$last_date)
    {
        $query  = "";
        $query .= "SELECT * FROM rpt_task_ism_wise WHERE ism_type = '$ism_type' AND ism_code = '$ism_code' AND DATE(log_datetime) = '$last_date' ORDER BY id ASC";
        //return $query;
        return $this->mysqli_lib->fetch_all($query);
    }

    function getTodayTask($ism_type,$ism_id,$present_date,$task_status)
    {
        $query  = "";
    ...
    function getTodayCompletedTask($ism_type,$ism_id,$present_date,$task_status)
    {
        $query  = "";
        $query .= "SELECT COUNT(*) AS task_counts FROM tbl_task_new WHERE task_ism_desc = '$ism_type' AND task_ism = '$ism_id' AND DATE(task_update_date) = '$present_date' AND task_status_id IN ($task_status) AND parent_task_id = '0' ORDER BY task_id ASC";
        //return $query;
        return $this->mysqli_lib->fetch_all($query);
    }
