...
if(isset($_GET)){
    ...
    if($id > 0){
        $data = $objProduct->GetHospital($id);
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="" method="POST">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="txtHospitalId" value="<?php echo($data[0]['id']); ?>" placeholder="Hospital Id" disabled />
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-md-2 control-label-my">Hospital</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="txtHospitalName" id="txtHospitalName" value="<?php echo($data[0]['fullname']); ?>" placeholder="Hospital Name" onkeypress="return validateAlphabets(event)"/>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#btnCategorySave', function () {
            ...
            var id = $('#txtHospitalId').val() !=0 ? $('#txtHospitalId').val() : 0;
            var action = id == 0 ? "hospital_save" : "hospital_edit";
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if(data == 'success'){
                            ...
                            setTimeout(function () { window.location.href = "hospital_view.php" }, 3000);
                        }else if(data == 'fail'){
    ...
    function validation() {
        ...
        if ($('#txtHospitalName').val() == '') {
            ...
            $('#txtHospitalName').addClass('error-val');
            $('#txtHospitalName').parent().find('.input-error').show().css('display', 'inline-block');
            ...
            $('#txtHospitalName').removeClass('error-val');
            $('#txtHospitalName').parent().find('.input-error').hide();
        }
