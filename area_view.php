...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">View City Areas</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">City Area Details</h4>
                </div>
                    ...
                    <table id="myTable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                          <?php foreach ($data as $row){ ?>
                              <tr>
                                  <td><?php echo $objProduct->GetRegionName($row['region_id']); ?></td>
                                  <td><?php echo $objProduct->GetCityName($row['city_id']); ?></td>
                                  <td><?php echo $row['area']; ?></td>
                                  <td class="center">
                                      <a class="btn btn-primary btn-sm checkUpdate" href="area_add.php?id=<?php echo $row['id']; ?>">
