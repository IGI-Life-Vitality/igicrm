<?php
$page_title = "Line Of Business";
$permission_type = "view";
$module_id = "36";
$parent_id = '20';
$menu_id = "Business_line_view";
...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">View Line Of Business</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
                    ...
                    <table id="myTable" class="table table-striped table-bordered">
                        ...
                        <?php foreach ($data as $row){ ?>
                            <tr>
                                ...
                                <td class="center">
                                    <a class="btn btn-primary btn-sm checkUpdate" href="business_line_add.php?id=<?php echo $row['id']; ?>">
