<?php
    $page_title = "View Subcategory";
    $permission_type = "view";
    $module_id = "32";
    $parent_id = '26';
    $menu_id = "task_subcategory_list";

    include('includes/header.php');
    include('classes/taskcat.php');

    $objTaskcat = new Taskcat();
    $data       = $objTaskcat->GetSubcategoriesAll();
?>
                    ...
                    <table id="tbltable" class="table table-striped table-bordered data-table">
                        ...
                        <?php foreach ($data as $row){ ?>
                            <tr>
                                ...
                                <td class="center">
                                    <a class="btn btn-primary btn-xs checkUpdate" href="task_subcategory_add.php?id=<?php echo $row['id']; ?>">
