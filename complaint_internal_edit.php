<?php
    ...
    $data                   = $objComplaint->GetComplaintByIdInternal($id,$cmode);
    // print_r($data);
?>
...
<div class="row">
    <form class="form-horizontal" action="#" method="POST" id="complaintInternal">
        ...
        <input type="hidden" id="actionI" name="actionI" value="edit_complaint">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtPriorityI" name="txtPriorityI" class="form-control" placeholder="Priority" readonly="true" value="<?php echo $data[0]['priority_id']; ?>">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control my-datepicker" id="reported_dtI"  placeholder="Complaint Received Date" value="<?php echo Date("d/m/Y",strtotime($data[0]['reported_dt'])) ?>">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control my-datepicker" id="received_dateI"  placeholder="Complaint Received Date" value="<?php echo Date("d/m/Y",strtotime($data[0]['received_date'])) ?>">
                        <span style="float: right; margin: -25px 15px 0px 0px;" class="input-group-input"><i class="fa fa-calendar"></i></span>
                        <div class="input-error form-control-input" style="color: Red; display: none;">Complaint Received Date is required</div>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="col-md-11">
                    <div class="form-group">
                        ...
                        <textarea placeholder="Additional Information" id="txtDescriptionI" name="txtDescriptionI" rows="6" class="form-control"><?php echo $data[0]['comments']; ?></textarea>
                    </div>
                </div>
                <div class="col-md-1">
                </div>
    ...
    function getcmp_type_int()
    {
        ...
        }).done(function (data) 
        {
           // alert(data);
            ...
            $('#ddlComplaintTypeI').val('<?php echo $data[0]['complaint_type_id']; ?>').trigger('change');
        });
    }
    get_cmp_type_detail_int();
