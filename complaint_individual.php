...
<div class="row">
    <form class="form-horizontal" action="#" method="POST" id="complaintIndividual">
        ...
        <input type="hidden" id="action" name="action" value="save_complaint">
        ...
        <input type="hidden" name="cmp_user" id="cmp_user" value="" />
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtCustomerName" name="txtCustomerName" class="form-control" placeholder="Policyholder Name">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtCNIC" name="txtCNIC" class="form-control" onkeypress="return validateNumbers(event)" placeholder="42201XXXXXXXX" maxlength="15">
            ...
            <div class="col-md-12">
				<div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control date my-datepicker" name="policy_issuance_date" id="policy_issuance_date" placeholder="Pick Preferable Date and Time" tabindex="13" />
            ...
            <div class="col-md-12">    
				<div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-control default-select2" id="ddlComplaintType" name="ddlComplaintType" data-placeholder="Select Complaint Type" onchange="get_cmp_type_detail_ind();">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtPremiumAmount" name="txtPremiumAmount" class="form-control" placeholder="Enter Premium Amount" onkeypress="return validateNumbers(event)">
            ...
            <div class="col-md-12"> 
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtAmountClaimed" name="txtAmountClaimed" class="form-control" placeholder="Enter Amount" onkeypress="return validateNumbers(event)">
            ...
            <div class="col-md-12"> 
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control my-datepicker" id="reported_dt" value="" placeholder="Complaint Received Date">
                            <span style="float: right; margin: -25px 15px 0px 0px;" class="input-group-input"><i class="fa fa-calendar"></i></span>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control my-datepicker" id="received_date" value="" placeholder="Complaint Received Date">
                            <span style="float: right; margin: -25px 15px 0px 0px;" class="input-group-input"><i class="fa fa-calendar"></i></span>
                            <div class="input-error form-control-input" style="color: Red; display: none;">Complaint Received Date is required</div>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                <div class="col-md-11">
                    <div class="form-group">
                        ...
                        <textarea placeholder="Additional Information" id="txtDescription" name="txtDescription" rows="6" class="form-control"></textarea>
                    </div>
                </div>
                <div class="col-md-1">
                </div>
            ...
            <div class="col-md-12">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtCallBack" name="txtCallBack" class="form-control" onkeypress="return validateNumbers(event)" placeholder="021XXXXXXXX" maxlength="11">
                    </div>
                </div>
                <div class="col-md-1">
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtHomePhone" name="txtHomePhone" class="form-control" onkeypress="return validateNumbers(event)" placeholder="92XXXXXXXXXX" maxlength="12">
                    </div>
                </div>
                <div class="col-md-1">
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtMobile" name="txtMobile" class="form-control" onkeypress="return validateNumbers(event)" placeholder="92XXXXXXXXXX" maxlength="12">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtOfficePhone" name="txtOfficePhone" class="form-control" onkeypress="return validateNumbers(event)" placeholder="021XXXXXXXX" maxlength="12">
                    </div>
                </div>
                <div class="col-md-1">
                </div>
            ...
            <div class="col-md-12">
                <div class="col-md-11">
                    <div class="form-group">
                        ...
                        <textarea rows="6" placeholder="Office Address" id="txtOfficeAddress" name="txtOfficeAddress" class="form-control"></textarea>
                    </div>
                </div>
                <div class="col-md-1">
                </div> 
            ...
            <div class="col-md-12">
                <div class="col-md-11">
                    <div class="form-group">
                        ...
                        <textarea rows="6" placeholder="Enter Address" id="txtCorrespondenceAddress" name="txtCorrespondenceAddress" class="form-control"></textarea>
            ...
            <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <div class="radio radio-css radio-inline radio-success">
                                <input type="radio" name="rdEmail" id="radio_inline_css_1" value="1" >
                            ...
                            <div class="radio radio-css radio-inline radio-danger">
                                <input type="radio" name="rdEmail" id="radio_inline_css_2" value="0" checked="true">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div>
                            <div class="radio radio-css radio-inline radio-success">
                                <input type="radio" name="rdSMS" id="radio_inline_css_3" value="1" >
                                <label for="radio_inline_css_3">
                                    Yes
                                </label>
                            </div>
                            <div class="radio radio-css radio-inline radio-danger">
                                <input type="radio" name="rdSMS" id="radio_inline_css_4" value="0" checked="true">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" maxlength="12" class="form-control" id="txtResponseNumber" name="txtResponseNumber" onkeypress="return validateNumbers(event)" placeholder="92XXXXXXXXXX">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div>
                            <div class="radio radio-css radio-inline radio-success">
                                <input type="radio" name="rdCallBack" id="radio_inline_css_12" value="1" >
                            ...
                            <div class="radio radio-css radio-inline radio-danger">
                                <input type="radio" name="rdCallBack" id="radio_inline_css_21" value="0" checked="true">
        ...
        <div class="col-md-12">
            <div class="col-md-2 form-group">
                <button type="button" class="btn btn-sm btn-primary" id="btnSaveComplaintIndividual"  onclick ="individual_cmp();" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Process..." >Save</button>
            </div>
        </div>
    </form>
</div>
...
<script type="text/javascript">
    ...
    function get_cmp_type_detail_ind()
    {
    ...
    function validation_ind()
    {
        ...
        if($('#status_of_policy').val() == null) 
        {
            $('#status_of_policy').addClass('error-val');
            $('#status_of_policy').parent().find('.input-error').show().css('display', 'inline-block');

            if (!hasFocus) 
            {
                $('#status_of_policy').focus();
                hasFocus = true;
            }
        ...
        {
            $('#status_of_policy').removeClass('error-val');
            //$('#txtTitle').parents('.control-group').addClass('success');
            $('#status_of_policy').parent().find('.input-error').hide();
        }
