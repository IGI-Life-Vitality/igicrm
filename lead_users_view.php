<?php
$page_title         = "View User Mapping";
$permission_type    = "view";
$module_id          = "41";
$parent_id          = '35';
$menu_id            = "view_user_mapping";
...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">View Leads User</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Leads User Mapping Details</h4>
                </div>
                              ...
                              <tr>
                                ...
                                <td>
                                  <?php
                                    ...
                                    {
                                      $pro_name = $objLead->GetProductsName($prod_id);
                                      $prod   = ucfirst($pro_name['fullname']);
                                      $product_nm .= $prod.", ";
                                      echo "<span>" . $product_nm . "</span>";
                                      $product_nm ="";
                                    }
                                  ?>
                                </td>
                                ...
                                <td class="center">
                                  <a class="btn btn-primary btn-xs checkUpdate" href="lead_users.php?id=<?php echo $row['id']; ?>"> Edit <i class="glyphicon glyphicon-edit icon-white"></i>
                                  </a>
                                </td>
                              </tr>
                          <?php } ?>
