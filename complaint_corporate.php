...
<div class="row">
    <form class="form-horizontal" action="#" method="POST" id="complaintCorporate">
        ...
        <input type="hidden" id="actionC" name="actionC" value="save_complaint">
			...
			<div class="col-md-12">
				<div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtGroupNo" name="txtGroupNo" class="form-control" placeholder="Group No" value="">
				...
				<div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtCertificate" name="txtCertificate" class="form-control" placeholder="Certificate No" maxlength="12" onblur="customer_data_group();">
				...
				<div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtMemberName" name="txtMemberName" class="form-control" placeholder="Member Name" onkeypress="return validateAlphabets(event)">
            ...
            <div class="col-md-12"> 
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtCNICC" name="txtCNICC" class="form-control" onkeypress="return validateNumbers(event)" placeholder="42201XXXXXXXX" maxlength="15">
				...
				<div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtCompanyName" name="txtCompanyName" class="form-control" placeholder="Company Name" onkeypress="return validateAlphabets(event)">
            ...
            <div class="col-md-12"> 
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control my-datepicker" name="policy_issuance_dateCC" id="policy_issuance_dateCC" placeholder="Pick Preferable Date and Time" tabindex="13" />
            ...
            <div class="col-md-12"> 
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control my-datepicker" id="reported_dtCC" value="" placeholder="Complaint Received Date">
                        <span style="float: right; margin: -25px 15px 0px 0px;" class="input-group-input"><i class="fa fa-calendar"></i></span>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control my-datepicker" id="received_dateCC" value="" placeholder="Complaint Received Date">
                        <span style="float: right; margin: -25px 15px 0px 0px;" class="input-group-input"><i class="fa fa-calendar"></i></span>
                        <div class="input-error form-control-input" style="color: Red; display: none;">Complaint Received Date is required</div>
                    </div>
                </div>
				<div class="col-md-1">
                 ...
                 <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtAgentBroker" name="txtAgentBroker" class="form-control" placeholder="Agent Or Broker Name" disabled="disabled">
                    </div>
                </div>
            </div>
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="col-md-11">
                    <div class="form-group">
                        ...
                        <textarea placeholder="Enter Description" id="txtDescriptionC" name="txtDescriptionC" rows="6" class="form-control"></textarea>
                    </div>
                </div>
                <div class="col-md-1">
                </div>
            ...
            <div class="col-md-12">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtCallBackC" name="txtCallBackC" class="form-control" onkeypress="return validateNumbers(event)" placeholder="021XXXXXXXX" maxlength="11">
                    </div>
                </div>
                <div class="col-md-1">
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtHomePhoneC" name="txtHomePhoneC" class="form-control" onkeypress="return validateNumbers(event)" placeholder="92XXXXXXXXXX" maxlength="12">
                    </div>
                </div>
                <div class="col-md-1">
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtMobileC" name="txtMobileC" class="form-control" onkeypress="return validateNumbers(event)" placeholder="92XXXXXXXXXX" maxlength="12">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtOfficePhoneC" name="txtOfficePhoneC" class="form-control" onkeypress="return validateNumbers(event)" placeholder="021XXXXXXXX" maxlength="12">
                    </div>
                </div>
                <div class="col-md-1">
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <!-- <div class="input-group"> -->
                            <input type="text" class="form-control" id="txtEmailC" name="txtEmailC" placeholder="example@mail.com">
            ...
            <div class="col-md-12">
                <div class="col-md-11">
                    <div class="form-group">
                        ...
                        <textarea rows="6" placeholder="Office Address" id="txtOfficeAddressC" name="txtOfficeAddressCOfficeAddressC" class="form-control"></textarea>
                    </div>
                </div>
                <div class="col-md-1">
                </div> 
            ...
            <div class="col-md-12">
                <div class="col-md-11">
                    <div class="form-group">
                        ...
                        <textarea rows="6" placeholder="Enter Address" id="txtCorrespondenceAddressC" name="txtCorrespondenceAddressC" class="form-control"></textarea>
            ...
            <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <div class="radio radio-css radio-inline radio-success">
                                <input type="radio" name="rdEmailC" id="radio_inline_css_c1" value="1" >
                                <label for="radio_inline_css_c1">
                                   Yes
                                </label>
                            </div>

                            <div class="radio radio-css radio-inline radio-danger">
                                <input type="radio" name="rdEmailC" id="radio_inline_css_c2" value="0" checked="true">
                                <label for="radio_inline_css_c2">
                                    No
                                </label>
                            </div>
                        </div>
                ...
                <div class="col-md-3" style="display: none;">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="txtCustomerEmailC" name="txtCustomerEmailC" placeholder="abc@example.com">
                            <div class="input-error form-control-input" style="color: Red; display: none;">Email Format is incorrect</div>
                            <span class="input-group-addon">@</span>
                        </div>
                    </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div>
                            <div class="radio radio-css radio-inline radio-success">
                                <input type="radio" name="rdSMSC" id="radio_inline_css_c3" value="1">
                                <label for="radio_inline_css_c3">
                                    Yes
                                </label>
                            </div>
                            <div class="radio radio-css radio-inline radio-danger">
                                <input type="radio" name="rdSMSC" id="radio_inline_css_c4" value="0" checked="true">
                ...
                <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="12" class="form-control" id="txtcusNumber" name="txtcusNumberC" onkeypress="return validateNumbers(event)" placeholder="92XXXXXXXXXX">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div>
                                <div class="radio radio-css radio-inline radio-success">
                                    <input type="radio" name="rdCallBackC" id="radio_inline_css_144" value="1" >
                                ...
                                <div class="radio radio-css radio-inline radio-danger">
                                    <input type="radio" name="rdCallBackC" id="radio_inline_css_1444" value="0" checked="true">
...
<script type="text/javascript">
    ...
    function validation_co()
    {
        ...
        if($('#status_of_policyCC').val() == null) 
        {
            $('#status_of_policyCC').addClass('error-val');
            $('#status_of_policyCC').parent().find('.input-error').show().css('display', 'inline-block');

            if (!hasFocus) 
            {
                $('#status_of_policyCC').focus();
                hasFocus = true;
            }
        ...
        {
            $('#status_of_policyCC').removeClass('error-val');
            //$('#txtTitle').parents('.control-group').addClass('success');
            $('#status_of_policyCC').parent().find('.input-error').hide();
        }
