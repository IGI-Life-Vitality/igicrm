...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">View Complaint Types</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">View Complaint Types</h1>
    <!-- end page-header -->
                    ...
                    <table id="data-table" class="table table-striped table-bordered">
                        ...
                        <?php foreach($data as $row){ ?>
                            ...
                            <tr>
                                ...
                                <td><? echo $row["tat"] ?> Days</td>

                                <td style="text-align: center;"><input type="checkbox" <?php echo ($row['isactive'] ? "checked='checked'" : ""); ?> disabled="disabled"></td>

                                <td class="center">
                                    <a class="btn btn-primary btn-sm checkUpdate" href="complaint_types_add.php?id=<?php echo $row['id']; ?>">
