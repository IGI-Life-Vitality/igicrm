<?php
    $page_title         = "Annual Departmental Summary Report";
    $permission_type    = "view";
    $module_id          = "65";
    $parent_id          = "25";
    $parent_id2         = "61";
    $menu_id            = "rpt_cmp_annual_departmental_summary";
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <a href="javascript: window.location.href = 'rpt_cmp_annual_departmental_summary.php'" class="btn btn-sm btn-inverse">Reset</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <table id="tblMyTable" class="table table-igi table-responsive">
                                <tbody>
                                    <tr>
                                        <td align="left">
                                            <h4>Annual Departmental Complaint Analysis Report</h4>
                                        </td>
                                        <td></td>
                                        <td align="right">
...
<script type="text/javascript">
    function search()
    {
        ...
        if(validation())
        {
            $.ajax({
                ...
                data: 
                {
                    'action'     :'search_cmp_annual_departmental_complaint_rpt',
                    'getYear'    :getYear
                },
    ...
    function exportAllReport()
    {
        $.ajax({
            ...
            data:
            {
                'action': 'export_cmp_annual_departmental_complaint_rpt'
            },
            success: function(data)
            {
                window.open(SITE_IP + "/reports/rpt_cmp_annual_departmental_complaint_download_all.php");
            }
        }).done(function (data) {
            console.log(data);
        });
        ...
        if(validation())
        {
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    window.open(SITE_IP + "/reports/rpt_cmp_annual_departmental_complaint_download.php?getYear="+getYear);
                }
            }).done(function (data) {
                console.log(data);
            });
