...
var handleDatepicker = function () {
    ...
    $(".default-select2").select2(), $(".multiple-select2").select2({placeholder: "Select"})
}, handleDateTimePicker = function () {
    $("#datetimepicker1").datetimepicker(),$("#datetimepicker2").datetimepicker(),$("#datetimepicker12").datetimepicker(), $("#datetimepicker2").datetimepicker({format: "LT"}), $("#datetimepicker3").datetimepicker(), $("#datetimepicker4").datetimepicker(), $("#datetimepicker3").on("dp.change", function (e) {
