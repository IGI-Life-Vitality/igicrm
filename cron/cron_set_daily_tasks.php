<?php
    ...
    foreach($isms as $ism)
    {
        ...
        $getBFDetails = $objTaskcatReport->GetBFDetailDateWise($ism_sub_cat_id,$ism_id,$incomming_status,$present_date,$last_date);
      
        `echo "$present_date|$ism_sub_cat_id|$ism_id|$incomming_status|$present_date|$last_date" >> /tmp/log_cron_set_daily_tasks.log`;
