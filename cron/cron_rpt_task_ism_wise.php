<?php
    ...
    foreach($isms as $ism)
    {
        ...
        $getBFDetails = $objTaskcatReport->getBFDetails($ism_sub_cat_id,$ism_id,$incomming_status,$present_date,$last_date);
        $bf           = $getBFDetails['bf'];
        //print_r("BF task " . $bf); die;
        ...
        //print_r("incomming task " . $incomming); die;
        ...
        $TaskDiffs = $objTaskcatReport->getTaskDiff($ism_sub_cat_id,$ism_id,$present_date);
