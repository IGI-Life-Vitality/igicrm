...
<div id="page-container" class="fade">
    ...
    <div class="login login-v2" data-pageload-addclass="animated fadeIn">
        ...
        <div class="login-header">
            <div class="brand">
                <span class="logo"><img src="assets/img/logo.png" alt="IGI Life"></span>
            </div>
        ...
        <div class="login-content">
            <form action="#" method="POST" class="margin-bottom-0" id="LoginForm">
                <div class="form-group m-b-20">
                    <input type="text" class="form-control input-lg" placeholder="Email Address" id="txtUserid" name="txtUserid" />
                </div>
                <div class="form-group m-b-20">
    ...
    function login() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                }else if(data == 'user block'){
                      $.notifyBar({ cssClass: "error", html: "Error Occured, User has been blocked for 15 minutes", delay: 2000, animationSpeed: "normal" });
