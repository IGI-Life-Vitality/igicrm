<?php
    $page_title         = "Lead City Wise Analysis";
    $permission_type    = "view";
    $module_id          = "49";
    $parent_id          = "25";
    $parent_id2         = "25";
    $menu_id            = "rpt_lead_citywise";
    ...
    $data              = $objLeadReport->countsLeadsByCity('','','');
?>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <a href="javascript: window.location.href = 'rpt_lead_citywise.php'" class="btn btn-sm btn-inverse">Reset</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <table id="tblMyTable" class="table table-igi table-responsive">
                                <tbody>
                                    ...
                                    <!-- <tr class="spanToDate">
                                        <td align="left">
                                            <b class="ToDate">City:</b> 
                                            <span id="spanRgCity"> - All</span>
                                        </td>
                                    </tr> -->
                                </tbody>
                            </table>
                    ...
                    <table id="tblTable" class="table table-igi table-responsive table-bordered">
                        ...
                        <tbody class="table table-bordered">
                            <?php foreach($citylop as $cityloop): ?>
                                <?php
                                    $city_id = $cityloop['id'];
                                    $data1 = $objLeadReport->countsLeadsByCityOnPageLoad($city_id);
                                ?>
                                <tr>
                                    <td rowspan="6"><?php echo $cityloop['city_name']; ?></td>
                                    <td rowspan="6">
                                        <?php 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                            echo number_format($data1[0]['inprogress_leads']/$data[0]['counts']*100, 2); 
                                        ?>%
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                            echo number_format($data1[0]['followup_leads']/$data[0]['counts']*100, 2); 
                                        ?>%
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                            echo number_format($data1[0]['bought_leads']/$data[0]['counts']*100, 2); 
                                        ?>%
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                            echo number_format($data1[0]['not_interested_leads']/$data[0]['counts']*100, 2); 
                                        ?>%
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                            echo number_format($data1[0]['general_inquiry_leads']/$data[0]['counts']*100, 2); 
                                        ?>%
                                    </td>
                                </tr>
                            <?php endforeach; ?>
...
<script type="text/javascript">
    function search()
    {
        ...
        {*/
            $.ajax({
                ...
                data: 
                {
                    'action'     :'search_lead_citywise_rpt',
                    'FromDate'   :FromDate,
                    'ToDate'     :ToDate,
                    'RgCity'     :RgCity
                },
    ...
    function exportAllReport()
    {
        $.ajax({
            ...
            data:
            {
                'action': 'export_all_lead_citywise_report'
            },
            success: function(data)
            {
                window.open(SITE_IP + "/reports/rpt_lead_citywise_download_all.php");
            }
        }).done(function (data) {
            console.log(data);
        });
    ...
    function exportFilterReport()
    {
        ...
        {*/
            $.ajax({
                ...
                data:
                {
                    'action': 'export_lead_citywise_report',
                    'FromDate': FromDate,
                    'ToDate': ToDate,
                    'RgCity': RgCity
                },
                success: function(data)
                {
                    ...
                    window.open(SITE_IP + "/reports/rpt_lead_citywise_download.php?fDate="+fDate+"&tDate="+tDate+"&RgCity="+RgCity);
                }
            }).done(function (data) {
                console.log(data);
            });
