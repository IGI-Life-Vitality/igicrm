<?php
    ...
    $data                   = $objComplaint->GetComplaintByIdBanca($id,$cmode);
?>
...
<div class="row">
    <form class="form-horizontal" action="#" method="POST" id="complaintBanca">
        ...
        <input type="hidden" id="actionB" name="actionB" value="edit_complaint">
        <input type="hidden" name="txtCounterDisplayB" id="txtCounterDisplayB" value="<?php echo $data[0]['complaint_num'];?>" />
        <input type="hidden" name="txtCounterB" id="txtCounterB" value="" />
        ...
        <input type="hidden" id="txtComplaintNoB" name="txtComplaintNoB" class="form-control" value="">
            ...
            <div class="col-md-12">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtPolicyNumberB" name="txtPolicyNumberB" class="form-control" placeholder="Policy Number" value="<?php echo $data[0]['policy_num']; ?>" >
                ...
                <div class="col-md-3">
					<div class="form-group">
						...
						<input type="text" id="txtCustomerNameB" name="txtCustomerNameB" class="form-control" placeholder="Policyholder Name" value="<?php echo $data[0]['customer_name']; ?>">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtCNICB" name="txtCNICB" class="form-control" onkeypress="return validateNumbers(event)" placeholder="42201XXXXXXXX" maxlength="15" value="<?php echo $data[0]['cnic']; ?>">
            ...
            <div class="col-md-12">
				<div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control my-datepicker" name="policy_issuance_dateBI" id="policy_issuance_dateBI" placeholder="Pick Preferable Date and Time" tabindex="13" value="<?php echo Date('d/m/Y',strtotime($data[0]['policy_issuance_date'])); ?>"/>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtPremiumAmountBI" name="txtPremiumAmountBI" value="<?php echo $data[0]['premium_amount']; ?>" class="form-control" placeholder="Enter Premium Amount" onkeypress="return validateNumbers(event)">
            ...
            <div class="col-md-12">
                <!-- <div class="col-md-3" style="display: none;">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtRefundAmountBI" name="txtRefundAmountBI" class="form-control" placeholder="Enter Refund Amount" value="<?php echo $data[0]['refund_amount']; ?>" onkeypress="return validateNumbers(event)" >
                    </div>
                </div>
                <div class="col-md-1">
                </div> -->
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtAmountClaimedBI" name="txtAmountClaimedBI" class="form-control" placeholder="Enter Amount" value="<?php echo $data[0]['claim_amount']; ?>" onkeypress="return validateNumbers(event)">
            ...
            <div class="col-md-12">
				...
				<div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control my-datepicker" id="reported_dtB" value="<?php echo Date("d/m/Y",strtotime($data[0]['reported_dt'])) ?>" placeholder="Complaint Received Date">
                        <span style="float: right; margin: -25px 15px 0px 0px;" class="input-group-input"><i class="fa fa-calendar"></i></span>
			...
			<div class="col-md-12">
				<div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control my-datepicker" id="received_dateBI" value="<?php echo Date("d/m/Y",strtotime($data[0]['received_date'])) ?>"  placeholder="Complaint Received Date">
                        <span style="float: right; margin: -25px 15px 0px 0px;" class="input-group-input"><i class="fa fa-calendar"></i></span>
                        <div class="input-error form-control-input" style="color: Red; display: none;">Complaint Received Date is required</div>
                    </div>
                </div>
				...
				<div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="ddlPriorityB" name="ddlPriorityB" class="form-control" value="<?php echo $data[0]['priority_id']; ?>" placeholder="Priority" disabled="disabled">
				...
				<div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtComplaintTATB" name="txtComplaintTATB" class="form-control" placeholder="Complaint TAT" value="<?php echo $data[0]['tat']; ?>" disabled="disabled">
                    </div>
                </div>
				<div class="col-md-1">
                </div>
            ...
            <div class="col-md-12">
                <div class="col-md-7">
                    <div class="form-group">
                        ...
                        <textarea placeholder="Additional Information" id="txtDescriptionB" name="txtDescriptionB" rows="4" class="form-control"><?php echo $data[0]['description']; ?></textarea>
                    </div>
                </div>
                <div class="col-md-1">
                </div>
            ...
            <div class="col-md-12">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtCallBackB" name="txtCallBackB" class="form-control" onkeypress="return validateNumbers(event)" placeholder="021XXXXXXXX" maxlength="11" value="<?php echo $data[0]['callback_num']; ?>">
                    </div>
                </div>
                <div class="col-md-1">
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtHomePhoneB" name="txtHomePhoneB" class="form-control" onkeypress="return validateNumbers(event)" placeholder="92XXXXXXXXXX" maxlength="12" value="<?php echo $data[0]['residence_phone']; ?>">
                    </div>
                </div>
                <div class="col-md-1">
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtMobileB" name="txtMobileB" class="form-control" onkeypress="return validateNumbers(event)" placeholder="92XXXXXXXXXX" maxlength="12" value="<?php echo $data[0]['mobile_number']; ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="txtOfficePhoneB" name="txtOfficePhoneB" class="form-control" onkeypress="return validateNumbers(event)" placeholder="021XXXXXXXX" maxlength="12" value="<?php echo $data[0]['office_phone']; ?>">
                    </div>
                </div>
                <div class="col-md-1">
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <!-- <div class="input-group"> -->
                            <input type="text" class="form-control" id="txtEmailB" name="txtEmailB" placeholder="example@mail.com" value="<?php echo $data[0]['email']; ?>">
            ...
            <div class="col-md-12">
                <div class="col-md-11">
                    <div class="form-group">
                        ...
                        <textarea rows="6" placeholder="Enter Office Address" id="txtOfficeAddressB" name="txtOfficeAddressB" class="form-control"><?php echo $data[0]['office_address']; ?></textarea>
                    </div>
                </div>
                <div class="col-md-1">
                </div>
            ...
            <div class="col-md-12">
                <div class="col-md-11">
                    <div class="form-group">
                        ...
                        <textarea rows="6" placeholder="Enter Address" id="txtCorrespondenceAddressB" name="txtCorrespondenceAddressB" class="form-control"><?php echo $data[0]['delivery_address']; ?></textarea>
            ...
            <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <div class="radio radio-css radio-inline radio-success">
                                <input type="radio" name="rdSMSB" id="radio_inline_css_bi3" value="1" <?php echo $data[0]['is_sms'] == '1' ? 'checked': '' ?>>
                                <label for="radio_inline_css_bi3">
                                    Yes
                                </label>
                            </div>
                            <div class="radio radio-css radio-inline radio-danger">
                                <input type="radio" name="rdSMSB" id="radio_inline_css_bi4" value="0" <?php echo $data[0]['is_sms'] == '0' ? 'checked': '' ?>>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" maxlength="12" class="form-control" id="txtResponseNumberB" name="txtResponseNumberB" onkeypress="return validateNumbers(event)" placeholder="92XXXXXXXXXX" value="<?php echo $data[0]['response_number']; ?>">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div>
                            <div class="radio radio-css radio-inline radio-success">
                                <input type="radio" name="rdCallBackB" id="radio_inline_css_bi12" value="1" <?php echo $data[0]['is_call_back'] == '1' ? 'checked': '' ?>>
                            ...
                            <div class="radio radio-css radio-inline radio-danger">
                                <input type="radio" name="rdCallBackB" id="radio_inline_css_bi21" value="0" <?php echo $data[0]['is_call_back'] == '0' ? 'checked': '' ?>>
...
<script type="text/javascript">
    ...
    function getcmp_type_bnk()
    {
        ...
        $.ajax({
            ...
            $('#ddlComplaintTypeB').val('<?php echo $data[0]['complaint_type_id']; ?>').trigger('change');
        });
    }
    get_cmp_type_detail_bnk();
    ...
    function banca_cmp()
    {
        ...
        var reported_dt = $('#reported_dtB').val();
    ...
    function validation_bnk()
    {
        ...
        //     //$('#txtRefundAmountBI').parents('.control-group').addClass('success');
        ...
        if($('#reported_dtB').val() == '') 
        {
            $('#reported_dtB').addClass('error-val');
            $('#reported_dtB').parent().find('.input-error').show().css('display', 'inline-block');
        ...
        {
            $('#reported_dtB').removeClass('error-val');
            //$('#reported_dtB').parents('.control-group').addClass('success');
            $('#reported_dtB').parent().find('.input-error').hide();
        }
