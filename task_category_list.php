<?php
$page_title = "View Task Category";
$permission_type = "view";
$module_id = "30";
$parent_id = '26';
$menu_id = "task_category_list";

include('includes/header.php');
include('classes/taskcat.php');

$objTaskcat = new Taskcat();
$data = $objTaskcat->GetTaskCategory();
?>
                    ...
                    <table id="tbltable" class="table table-striped table-bordered data-table">
                        ...
                        <?php foreach ($data as $row){ ?>
                            <tr>
                                ...
                                <td class="center">
                                    <a class="btn btn-xs btn-primary btn-sm checkUpdate" href="task_category_add.php?id=<?php echo $row['id']; ?>">
                                        Edit <i class="glyphicon glyphicon-edit icon-white"></i>
                                    </a>
                                    <!-- <a class="btn btn-xs btn-danger btn-sm checkDelete" href="#" onclick="javascript:return show_confirm(<?php echo $row['id']; ?>);">
