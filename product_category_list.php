...
$module_id = "12";
$parent_id = '21';
$menu_id = "product_category_list";

include('includes/header.php');
include('classes/product.php');

$objProduct = new Product();
$data = $objProduct->GetProductCategory();
?>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Product Category Details</h4>
                </div>
                        ...
                        <tbody>
                            <?php foreach ($data as $row) { ?>
                                <tr>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-primary btn-sm checkUpdate" href="product_category_add.php?id=<?php echo $row['id']; ?>">
