                        ...
                        <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control default-select2" id="ddlTaskCategory" name="ddlTaskCategory" data-size="10" data-live-search="true" data-style="btn-white" onchange="task_cat();">
                                            ...
                                            <?php foreach($getTaskCat as $getTaskCats) { ?>
                                                <option value="<? echo $getTaskCats["id"]; ?>">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Task Id</label>
                                        <input type="text" class="form-control" id="task_number" value="" placeholder="Task Id">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <button type="button" class="btn btn-sm btn-primary" id="customSearch" onclick="//search();">Search</button>
                                        <button type="reset" class="btn btn-sm btn-primary" onclick="reset();">Reset</button>
                                        <a  href="javascript:void(0)"  id="exportBtn" class="btn btn-sm btn-success">Export Task Raw Data</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    function search()
    {
        ...
        var taskNumber     = $('#task_number').val();
        ...
        if(policy != '' || taskNumber != '' || TaskCategory != null || SubCategory != null || txtISM != null || FromDate!= '' || ToDate != '' || tsk_status != null)
        {
            $.ajax({
                data: 
                {
...
<script type="text/javascript" language="javascript">
    $( document ).ready(function() {
        var dt = $('#task_grid').DataTable({
            ...
            "ajax":
            {
                ...
                "data": function ( d ) {
                    debugger
                    d.policy         = $('#policy').val();
                    d.task_number     = $('#task_number').val();
                    d.TaskCategory   = $('#ddlTaskCategory').val();
                    d.SubCategory    = $('#ddlSubCategory').val();
                    d.txtISM         = $('#txtISM').val();
                    d.tsk_status     = $('#tsk_status').val();
        ...
        $("#customSearch").on("click",function(){
            $("#customSearch").text("Processing...");
            $("#customSearch").addClass("disabled");
            dt.draw();
        });

        $(document).ajaxComplete(function(event,xhr,options){
            $("#customSearch").text("Search");
            $("#customSearch").removeClass("disabled");
    ...
    let fromDate = document.getElementById('txtFromDate').value;
    let toDate = document.getElementById('txtToDate').value;
    if (!fromDate || !toDate) {
        alert("Please select both dates");
        return;
    }
    let url = "raw_data/export_task_raw_data.php?from_date=" 
