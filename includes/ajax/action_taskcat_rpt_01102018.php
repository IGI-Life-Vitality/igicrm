    ...
    if(isset($_POST['action'])) 
    {
        ...
        elseif($action == 'search_task_ism_wise_rpt')
        {
            ...
            $output .='<table id="tblTable" class="table table-igi table-responsive table-bordered">';
                            ...
                            if(count($ismDetails) > 0)
                            {
                                $output .='<tbody>';
                                    $output .='<tr>';
                                        ...
                                        $output .='<td class="text-center line-hight">'.$ismDetail['bf'].'</td>';
                                        ...
                                        $output .='<td class="text-center line-hight">'.$ismDetail['cf'].'</td>';
                                ...
                                $SUM_AvgMinutesPerActivity = $SUM_AvgMinutesPerActivity + $ismDetail['avg_mint_activity'];
                                $SUM_BF = $SUM_BF + $ismDetail['bf'];
                                $SUM_Incoming = $SUM_Incoming + $ismDetail['incomming'];
                                $SUM_Total = $SUM_Total + $ismDetail['total'];
                                $SUM_Today_Completed = $SUM_Today_Completed + $ismDetail['today_completed'];
                                $SUM_CF = $SUM_CF + $ismDetail['cf'];
                                $SUM_Main_Hours = $SUM_Main_Hours + $ismDetail['main_hours'];
                                $SUM_Day1 = $SUM_Day1 + $ismDetail['day_1'];
                                $SUM_Day2 = $SUM_Day2 + $ismDetail['day_2'];
                                $SUM_Day3 = $SUM_Day3 + $ismDetail['day_3'];
                                $SUM_Day4 = $SUM_Day4 + $ismDetail['day_4_above'];
                            }
                            else
                            {
                                echo "NA";
                        ...
                        $output .='<tfoot>';
                            $output .='<tr>';
                                $output .='<td colspan="3">Grand Total</td>';
                                $output .='<td class="text-center line-hight">'.$SUM_AvgMinutesPerActivity.'</td>';
                            ...
                            $output .='</tr>';
                            $output .='<tr>';
                                $output .='<td colspan="3"><b>Manpower in working hours includes, given extra time </b></td>';
