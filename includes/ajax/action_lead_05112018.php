...
if(isset($_POST)) 
{
    ...
    if(isset($_POST['action'])) 
    {
        ...
        if($action == "save_lead")
        {
            ...
            $res         = $result[0];
            $leadid      = $result[1];
            $lead_number = $result[2];
            $send_mail   = $result[3];     //not using now.
            ...
            if($res == "success")
            {
                ...
                $cc_emails = "";
                $subject = "Subject for Lead Acknowladgement";

                //$sb .="Hi,<br /> <br />";
                //$sb .= "Please be informed that NEW Meeting has been scheduled as per below details:  <br /> <br />";

                $sb .="Thanks You, Lead Acknowladgement By IGI Life CRM";
                ...
                $sb .="<tr>";
                    $sb .=" <td style='text-align:center; border: 1px solid #ddd; padding: 8px;'>Lead Acknowladgement By IGI Life CRM</td>";
                ...
                try
                {
                    ...
                    $subject = "Lead Acknowladgement by IGI Life CRM";
