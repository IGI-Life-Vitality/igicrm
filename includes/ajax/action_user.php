...
if(isset($_POST)) 
{
    ...
    if (isset($_POST['action'])) 
    {
        ...
        if($action == "save")
        {
            ...
            $response = $objUser->AddUsers($first_name,$last_name,$user_type,$user_id,$email,$password,$employee_id,$mobile,$location,$group_id,$date_time,$is_active,$medium);
        ...
        elseif($action == "edit")
        {
            $response =  $objUser->UpdateUsers($id,$first_name,$last_name,$user_id,$user_type,$email,$password,$mobile,$location,$date_time,$group_id,$is_active);
