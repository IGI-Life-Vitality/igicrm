            ...
            <? } else { ?>
                ...
                <li class="has-sub <? echo ($parent_id == '35' ? 'active' : ''); ?>">
                    ...
                    <ul class="sub-menu">
                      ...
                      <li class="<? echo ($menu_id == 'lead_user_add' ? 'active' : ''); ?>"><a href="lead_users.php">Add Leads Users</a></li>
                        <li class="<? echo ($menu_id == 'leads_users_view' ? 'active' : ''); ?>"><a href="lead_users_view.php">View Leads Users</a></li>
