            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" autocomplete="off">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label-my">Regions<span style="color: red;">*</span></label>
                            <div class="col-md-4">
                                <select class="default-select2 form-control" id="region_id" name="region_id" <?php echo $isdisable; ?> onchange="//asign_to();">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label-my">City Name</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="txtName" id="txtName" value="<?php echo($data[0]['fullname']); ?>" placeholder="City Name"/>
                                <div class="input-error form-control-input" style="color: Red; display: none;">City Name is required</div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <button type="button" onclick="save();" class="btn btn-sm btn-primary" id="btnSaveCity" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Process..."  >Save</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<script type="text/javascript">
    ...
    function validation()
    {
        ...
        {
            $('#region_id').addClass('error-val');
            $('#region_id').parent().find('.input-error').show().css('display', 'inline-block');
        ...
        {
            $('#region_id').removeClass('error-val');
            $('#region_id').parent().find('.input-error').hide();
        }
    ...
    function save() 
    {
        ...
        var action = id == 0 ? "save_city" : "edit_city";
        ...
        if(validation())
        {
            ...
            $.ajax({
                ...
                success: function(data) 
                {
                    ...
                    {
                        clear_values();
                       $.notifyBar({ cssClass: "success", html: "City Saved Successfully", delay: 2000, animationSpeed: "normal" });
                        setTimeout(function () {
                            window.location.href = "city_view.php"
                        }, 2000);
                    }
                    else
                    {
