<?php
    ...
    $complaintType = isset($_GET['getComplaintType'])?$_GET['getComplaintType']:'';
    ...
    $data       = $objComplaintReport->countsComplaintTypewiseOnLoad($departmentName,$complaintType,$durationType,$month,$quarter,$year);
    ...
    {
        $getDepartment = $objComplaintReport->getDepartmentById($departmentName);
    ...
    header('Content-Disposition: attachment; filename="rpt_cmp_typewise_downlod.xls"');
?>
    ...
    <table id="tblMyTables" class="table table-igi table-responsive">
        <thead>
            <tr class="tblHead">
                ...
                <th width="300px;">Complaint Type</th>
                <th width="100px;">Complaints logged in (Selected Duration)</th>
