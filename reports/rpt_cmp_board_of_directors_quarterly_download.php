<?php
    ...
    header('Content-Disposition: attachment; filename="rpt_cmp_board_of_directors_quarterly_download.xls"');
?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="right" colspan="6">
                        ...
                        <span id="spanForum"> <?php echo $f_name; ?> </span>
                    </td>
                </tr>
            </tbody>
        </table>
                ...
                <?php for($i=0; $i<count($data2); $i++) { ?>
                    <tr>
                        <?php if($data2 != 0) {  ?>
                            ...
                            ?>
                            <td class="text-center"><?php echo $cmp_open_q1; ?></td>
