<?php
    ...
    header('Content-Disposition: attachment; filename="rpt_cmp_channelwise_downlod.xls"');
?>
    ...
    <table id="tblMyTables" class="table table-igi table-responsive">
        ...
        <tbody class="table table-bordered">
            ...
            <?php foreach($deprtments as $deprtment): ?>
                ...
                ?>
                <tr>
                    <td rowspan="7" valign="top" align="left"><?php echo $deprtment['primary_name']; ?>
                    </td>
                ...
                <?php $CMPChannelWiseTotal = $CMPChannelWiseTotal + $channel_counts[0]['CMPSUM']; ?>
            <?php endforeach; ?>
        </tbody>
        ...
        <tfoot>
            <tr class="tblFoot">
                ...
                <td><?php echo $CMPChannelWiseTotal; ?></td>
