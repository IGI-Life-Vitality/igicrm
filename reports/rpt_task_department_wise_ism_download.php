<?php
    ...
    header('Content-Disposition: attachment; filename="rpt_task_department_wise_ism_download.xls"');
?>
            ...
            <tbody>
                ...
                <tr>
                    <td align="left">
                        ...
                        <span id="spanDepartmentName"> <?php print_r($deprtments[0]['primary_name']); ?> </span>
                    </td>
                    <td></td>
                ...
                <tr>
                    ...
                    <?php
                        for($x=0; $x<count($data2); $x++) 
                        {
                            ...
                            $ism_id1 = $data2[$x]['id'];
                            $task_rating1 = $objTaskcatReport->getTaskRating($ism_id1,$durationType,$month,'','',$deprtment_id);
                            //print_r($task_rating1); die;
