<?php
    ...
    header('Content-Disposition: attachment; filename="rpt_lead_citywise_report_download_all.xls"');
?>
        ...
        <tbody>
            <tr>
                ...
                <td align="right" valign="top">
                    <h3>All Leads Citywise Report</h3>
                </td>
            </tr>
                        <tr>
                <td align="left">
    ...
    <table id="tblMyTable" class="table table-igi table-responsive">
        ...
        <tbody class="table table-bordered">
            <?php foreach($citylop as $cityloop): ?>
                ...
                ?>
                <tr>
                    <td rowspan="6" valign="top"><?php echo $cityloop['city_name']; ?></td>
