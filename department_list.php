<?php
$page_title = "Department Views";
$group_id = "department";
$menu_id = "department_view";

include('includes/header.php');
$data = $objUser->GetDeparments(0);
                    ...
                    <table id="data-table" class="table table-striped table-bordered">
                        ...
                        <?php foreach ($data as $row){ ?>
                            ...
                            <tr>
                                ...
                                <td class="center">
                                    <a class="btn btn-primary btn-sm" href="department_add.php?id=<?php echo $row['id']; ?>">
