...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">View Organization Role</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
                ...
                <div class="panel-body">
                    <form class="form-horizontal" autocomplete="off">
                        <div class="form-group">
                            <label class="col-md-2 control-label-my"> Role Name</label>
                            <div class="col-md-4">
